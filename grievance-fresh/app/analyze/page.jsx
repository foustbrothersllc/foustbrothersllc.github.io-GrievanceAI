      ...
      <main className="max-w-6xl mx-auto p-6">
        {contract && (
          <>
            ...
            <button onClick={handleAnalyze} disabled={analyzing} className="bg-ups-brown text-ups-gold px-8 py-3 rounded uppercase font-bold mb-8">{analyzing ? 'Analyzing...' : 'Analyze Contract'}</button>
            {results && (
