  ...
  return (
    <div className="min-h-screen bg-ups-black flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-md">
        <Link href="/">
          <h1 className="text-4xl font-bold text-ups-gold text-center mb-12 hover:text-yellow-300 cursor-pointer">
            GRIEVANCE AI
          </h1>
        </Link>
        ...
        <div className="bg-gray-900 border-2 border-ups-brown rounded-lg p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-ups-brown hover:bg-ups-gold text-ups-gold hover:text-ups-brown font-bold py-2 px-4 rounded transition-all duration-300 uppercase disabled:opacity-50"
            >
          ...
          <p className="text-gray-400 text-center mt-6">
            ...
            <Link href="/signup">
              <span className="text-ups-gold hover:text-yellow-300 cursor-pointer font-semibold">Sign up</span>
            </Link>
          </p>
        </div>
      </div>
